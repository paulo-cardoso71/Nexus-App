  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4">
      <div className="flex flex-col gap-8">
        ...
        {/* Post Form (Only shows if logged in) */}
        {user && (
        ...
        <div className="space-y-6">
          {data?.getPosts.map((post) => (
            // THE FULL CARD:
            // bg-white (light) | dark:bg-slate-800 (dark)
            // shadow-sm (subtle) + hover:shadow-md (visual effect)
            <div 
              key={post.id} 
            ...
            >
               ...
               <div className="flex justify-between items-start mb-4">
                  ...
                  {/* Delete Button (Safety positioning) */}
               ...
               {/* Actions (Like and Comments) - CRITICAL AREA FIXED */}
